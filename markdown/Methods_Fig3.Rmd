...
threshtable=fread('../data/threshold_table.txt',data.table=F)
env="BLOIS_2014_OPT"
...
```{r}
snp_gwas=fread('../data/600K_GWAS_BLOIS_2014_OPT_results.txt',data.table=F)
...
df=snp_gwas[,1:4]
# Variables ====
mypalette=c('lightgrey','darkgrey','black')
...
png('Methods_Fig3.png',width=2000,height=1500)
...
## Manhattan plot for 1 trait, alternating colors of chromosomes
...
```{r}
#founder_threshold=10^-5.13284907365289
fp_gwas=fread('../data/Founder_GWAS_BLOIS_2014_OPT_results.txt',data.table=F)
...
hp_gwas=fread('../data/Haplotype_GWAS_BLOIS_2014_OPT_results.txt',data.table=F)
hp_gwas=hp_gwas[,!names(hp_gwas) %in% "HAPGRP"]
head(hp_gwas)
...
#legend <- get_legend(
  # create some space to the left of the legend
#  b2 + theme(legend.box.margin = margin(0, 0, 0, 12))
#)
...
png('../images/Methods_Fig3_onetrait.png',width=2000,height=1500)
